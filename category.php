	...
	<?php
		foreach($lastestItems as $item) {
			echo '<div class="col-md-3 col-6 product-item">
					...
					<p><button class="btn btn-success" onclick="addCart('.$item['id'].', 1)" style="width: 100%;background-color: #03a9f4;
					border-color: #03a9f4;  border-radius: 0px;"><i class="bi bi-cart-plus-fill"></i> Thêm giỏ hàng</button></p>
				</div>';
		}
	?>
	</div>
